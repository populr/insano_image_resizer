    ...
    describe "calculate_transform" do
      ...
      interest_variants_absolute.each do |ip|
        viewport_variants.each do |viewport|
          ...
          it "should produce the correct transform for viewport: #{viewport}, point: #{ip}" do
        ...
        viewport_variants.each do |viewport|
          ...
          it "should produce the correct transform for viewport: #{viewport}, point: #{ip}" do
            ...
            if (actual_printed == true)
              ...
              if (actual_results.size() == interest_variants_fractional.size() * viewport_variants.size())
